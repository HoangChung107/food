    ...
    <div id="wrapper">
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            try {
                ...
                $nguoigui = 'hoangchung1072000@gmail.com'; // Tài khoản Email
                $matkhau = 'hoangchung2k'; // Mật khẩu Email
                $mail->SMTPSecure = 'ssl';  // encryption TLS/SSL 
                $mail->Port = 465;  // Port kết nối: khai báo 465 hoặc 587                


                // Recipients - Người nhận
                $tennguoigui = 'Trần Hoàng Chung'; // Tên người gửi lấy từ form nhập
                $mail->Username = $nguoigui; // SMTP username
                $mail->Password = $matkhau;   // SMTP password
                $mail->setFrom($nguoigui, $tennguoigui); //mail và tên người nhận 
                $to = $email; // Email cần gửi đến lấy từ form nhập
                $to_name = "Trần Hoàng Chung"; // Tên người cần gửi đến
